    ...
    <>
      ...
      <div className="md:grid md:grid-cols-2 md:ml-[250px] md:gap-[30px] justify-center pt-[100px] pb-[50px] ">
        ...
        <div className="md:w-[300px] md:h-[300px] mt-[70px] md:right-[500px] text-center ">
          <p className="md:text-6xl sm:text-4xl text-3xl text-sky-700">
            30 Years Experience
          </p>
      ...
      <div className="w-full relative m-auto h-[300px] ">
        ...
        <div className="absolute  text-center md:inset-y md:left-40 sm:left-8 left-20 sm:inset-y-24 inset-y-20 upsize text - [40px] text-white item-center">
          ...
          <p className="md:text-xl sm:text-xl">
      ...
      <div id="contact" className="bg-slate-200 ">
        <div className=" text-center  sm:ml-4">
          <p className=" font-black mb:text-3xl sm:text-xl text-[#292E3D] pt-8">
            What can us do for you?
          </p>
          <p className=" font-semibold md:text-xl sm:text-lg  text-[#292E3D] mb-8">
            We are ready to work on a project of any complexity, whether it's
            commercial or residential.
          </p>
        </div>

        <div class="mx-auto max-w-[1920px] px-4 md:px-8 2xl:px-16 md:ml-[400px]">
              ...
              <div class="flex flex-col space-y-5">
                ...
                <div class="relative mb-4">
                  ...
                  <textarea
                    id="message"
                    name="message"
                    class="px-4 py-3 flex items-center w-full appearance-none transition duration-300 ease-in-out text-heading text-sm border border-2 focus:border-heading placeholder-body"
                    autoComplete="off"
                    spellCheck="false"
                    rows={4}
